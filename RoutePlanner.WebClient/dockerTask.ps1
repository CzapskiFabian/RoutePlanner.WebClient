...
.PARAMETER Clean
Removes the image routeplanner.webclient and kills all containers based on that image.
...
Build a Docker image named routeplanner.webclient
#>
...
$imageName="routeplanner.webclient"
$projectName="routeplannerwebclient"
$serviceName="routeplanner.webclient"
